        ...
        <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-8">
          <div>
            <h3 className="text-2xl font-semibold">
              PERFECT JOURNEYS WITH JO LIMO
            </h3>
            <p className="mt-4 text-gray-600">
              Exquisite chauffeured services via the Jo Limo app, available on
              iOS and Android.
            </p>
            <button className="mt-6 inline-flex items-center bg-black text-white px-5 py-3 uppercase text-sm hover:bg-gray-800">
              Download the app
            </button>
          </div>
          <div className="flex justify-center">
